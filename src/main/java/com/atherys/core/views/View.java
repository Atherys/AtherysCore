...
/**
 * A View is a type of object which will format and display an instance of a given class to a
 * player. Views must contains at least one public constructor, which accepts the appropriate type
 * as an argument, and nothing else.
 *
