...
public final class AtherysDamageTypes {
    ...
    public static final AtherysDamageType SLASH = new AtherysDamageType("atherys:slash", "Slashing",
            DamageTypes.ATTACK);
    public static final AtherysDamageType UNARMED = new AtherysDamageType("atherys:unarmed",
            "Unarmed", DamageTypes.ATTACK);
    // Ranged
    public static final AtherysDamageType PIERCE = new AtherysDamageType("atherys:pierce", "Piercing",
            DamageTypes.PROJECTILE);
    public static final AtherysDamageType BALLISTIC = new AtherysDamageType("atherys:ballistic",
            "Ballistic", DamageTypes.PROJECTILE);
    // Magic
    ...
    public static final AtherysDamageType MENTAL = new AtherysDamageType("atherys:mental", "Mental",
            DamageTypes.MAGIC);
    public static final AtherysDamageType RADIANT = new AtherysDamageType("atherys:radiant",
            "Radiant", DamageTypes.MAGIC);
    public static final AtherysDamageType NECROTIC = new AtherysDamageType("atherys:necrotic",
            "Necrotic", DamageTypes.MAGIC);
