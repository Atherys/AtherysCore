...
public class AtherysEntityDamageSourceBuilder extends AbstractEntityDamageSource.AbstractEntityDamageSourceBuilder<AtherysEntityDamageSource, AtherysEntityDamageSourceBuilder> {
