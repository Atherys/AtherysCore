...
public class TransactionalHibernateRepository<T extends Identifiable<ID>, ID extends Serializable> implements Repository<T, ID> {
    ...
    public TransactionalHibernateRepository(Class<T> persistable) {
