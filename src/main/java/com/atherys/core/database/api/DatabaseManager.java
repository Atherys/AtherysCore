...
public interface DatabaseManager<T extends DBObject> {
    ...
    /**
     * Remove the {@link DBObject} from the database. Implementations should do this purely based on the object's UUID, but this is not mandatory.
     *
    ...
    /**
     * If this DatabaseManager uses some sort of caching, call this method immediately after instantiation so as to cache all {@link DBObject}s stored in the database.
     */
    void loadAll ();
